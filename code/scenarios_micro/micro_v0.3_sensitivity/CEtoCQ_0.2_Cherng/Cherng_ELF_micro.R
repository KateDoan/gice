...
scenarioName <- "Cherg_ELF"
fCherng <- 0.2
ELFAge <- 18
big <- "US"
outDir <- file.path("code", "scenarios_micro", "micro_v0.3_sensitivity", "CEtoCQ_0.2_Cherng", "outData")
#############################################################################################################################
...
v.NE.primer=eTrans$NE; v.ND.primer=eTrans$ND; v.CD.primer=eTrans$CD; v.CE.primer=v.CQ.primer*fCherng; 
