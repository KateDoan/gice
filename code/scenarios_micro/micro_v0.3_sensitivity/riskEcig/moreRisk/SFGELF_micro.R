...
ELFAge <- 18
big <- "US"
outDir <- file.path("micro_v0.3_sensitivity", "riskEcig", "moreRisk", "outData")
#############################################################################################################################
source("micro_scenarios/util/microsimulation_preparation.R")
source("micro_scenarios/util/read_big_mat_transition.R")
init <- micro_prep()
...
a.ecig <- 0.01        # initiation rate of e-cig increases 1% annually
