...
# Get the utility, i.e. the unit QALY for the individual at time t
...
# START SIMULATION
p = Sys.time()
sim_no_trt  <- MicroSim(v.M_1, v.age, n.i, n.t, v.n, X = v.x, d.c, d.e, Trt = FALSE, seed = 200) # run for no treatment
