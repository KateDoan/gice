...
inDir <- "code/scenarios_macro/output/combined"
codeDir <- "code/figures/macroscenario_plots"
path_get_plots <- file.path(codeDir, "getPlotSet.R")
## Output plot directory
outDirPlot <- file.path(codeDir, "plotOutput")
######################################################################################################
# Plot settings
panelCol <- "white"
backgroundCol <- "white"
...
COLZ <- c(SQ=foregroundCol, MLA21='brown', MLA25='brown', SFG='violetred', TAX5='red', TAX2='red', 
          ELF='darkblue', E21='darkgreen', E25='seagreen1', EP='deepskyblue',
          MLATax5='darkviolet', MLAEP='lightpink',  Tax5EP='lightpink', MLATax5EP='darkorange',
          SFGELF='darkgoldenrod1')
# Linetypes: 1:solid, 2:dashed
LINETYPES <- c(SQ=1, MLA21=1, MLA25=2, SFG=1, ELF=1, E21=1, E25=2, EP=1, TAX5=1, TAX2=1,
               MLATax5=1, MLAEP=1, Tax5EP=2, MLATax5EP=1, SFGELF=2)
# Shapes: 4:cross, 21:circle, 24:triangle
SHAPES <- c(SQ=4, MLA21=4, MLA25=21, SFG=4, ELF=24, E21=24, E25=24, EP=24, TAX5=21, TAX2=4, 
            MLATax5=21, MLAEP=24,  Tax5EP=21, MLATax5EP=24, SFGELF=4)
SCENARIOS <- c("SQ", "MLA21", "MLA25", "SFG", "TAX5", "TAX2", "ELF", "E21", "E25",
...
LABELS <- c("Status Quo (SQ)", "Minimum Legal Age 21 (MLA21)", "Minimum Legal Age 25 (MLA25)",
            ...
            "E-cigarette Laissez-Faire (ELF)",  "E-cigarette 21 (E21)",  "E-cigarette 25 (E25)",
